...
/*   Updated: 2020/08/12 20:26:20 by roybakker     ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap(void) : 	_hit_pts(100), _energy_pts(100), _name("FR4G-TP"),
...
FragTrap::FragTrap(std::string name) : _hit_pts(100), _energy_pts(100), _name(name),
						    		   _melee_attack_dmg(30), _ranged_attack_dmg(20),
						               _armor_dmg_reduction(5)
{
	std::cout << "[" << this->_name << "]";
...
{
	std::cout << "[" << this->_name << "]";
	std::cout << " -- I can't feel my fingers! Gah! I don't have any fingers and I'm dead!" << std::endl;
	return ;
}
...
void		FragTrap::beRepaired(unsigned int amount)
{
	...
	else
	{
		...
		if (this->_hit_pts > (int)this->_max_hit_pts)
		{
			this->_hit_pts = this->_max_energy_pts;
